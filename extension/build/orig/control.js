...
window.onload = function(){
    ...
    document.querySelector('#bexportxy').onclick=function() {ui.export({xy: true}); return false;};
    document.querySelector('#bdoc').onclick=function() {ui.exportdoc(); return false;};
