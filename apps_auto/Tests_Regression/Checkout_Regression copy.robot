...
Apps > Checkout > Payment > Gift Msg - QASA-613
    ...
    Click Add Gift
    Verify Gift Text    Hi Test, Enjoy your gift! From AutoTester Test
    [Teardown]    Tear Down
...
Apps > Checkout > Payment > COD - QASA-535
    ...
    Click Cash Payment Method
    Click Payment Confirm Order
    Verify Text On Screen    You have chosen to pay with Cash on Delivery    ${MAX_TIMEOUT}
    Verify Text On Screen    Please have your cash ready for the driver
    [Teardown]    Tear Down
...
Apps > Checkout > Payment > Pay with Ozow - QASA-533
    ...
    Click Ozow Payment Method
    Click Pay With Ozow
    Verify Text On Screen    Select your bank    ${MAX_TIMEOUT}
    Click Back Screen
    Click Pay With Ozow
    Close Application
    Start Application
...
Apps > Checkout > Payment > Mobicred - QASA-527
    ...
    Click Mobicred Payment Method
    Click Pay With Mobi
    Verify Text On Screen    Please log in to your Mobicred account    ${MAX_TIMEOUT}
    [Teardown]    Tear Down
